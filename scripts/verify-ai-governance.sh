...
if git rev-parse --is-inside-work-tree >/dev/null 2>&1 &&
  git check-ignore -q docs/ai-governance/references/canonical-sources.md; then
  fail "canonical governance references must not be hidden by ignore rules"
fi
...
require_text "docs/ai-governance/03-evidence-and-completion-gates.md" "変更前と変更後"
require_text "docs/ai-governance/03-evidence-and-completion-gates.md" "latest meaningful change"
require_text "docs/ai-governance/14-issue-quality-gate.md" "体験が直接変わらないIssue"
require_text ".github/pull_request_template.md" "対象面"
require_text ".github/pull_request_template.md" "利用可能な自動・手動review"
require_text "docs/ai-governance/references/canonical-sources.md" "d7d4e3ca9d40e2c54ca9fa430a05dce721b2c2d9"
